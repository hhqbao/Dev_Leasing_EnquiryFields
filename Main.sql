...
ALTER TABLE LP_Customer ADD GenCapIncGstDesc varchar(255)
ALTER TABLE LP_Customer ADD GenCapExcGstDesc varchar(255)
ALTER TABLE LP_Customer ADD MealEntertainmentDesc varchar(255)
ALTER TABLE LP_Customer ADD SuperannuationDesc varchar(255)
ALTER TABLE LP_Customer ADD OtherExemptDesc varchar(255)
ALTER TABLE LP_Customer ADD RemoteAreaRentDesc varchar(255)
ALTER TABLE LP_Customer ADD RemoteAreaMortgageDesc varchar(255)
ALTER TABLE LP_Customer ADD RemoteAreaFuelDesc varchar(255)
ALTER TABLE LP_Customer ADD OtherPreTaxItemDesc varchar(255)
ALTER TABLE LP_Customer ADD OtherPosTaxItemDesc varchar(255)
/****** ****************************************************************************** ******/
